...
const AuthModal = ({ active, setModalActive, userPrefers }) => {
    ...
    return (
        <>
            {active && (
                <div className="fixed inset-0 flex items-center justify-center bg-[rgba(0,0,0,0.2)] backdrop-blur-md">
                    <div
                        ref={modalRef}
                        className={`flex flex-col items-center relative p-6 shadow-xl rounded-lg ${
                            userPrefers ? "bg-[#1c1b22]/85" : "bg-white"
                        }`}
                    >
                        <p className="text-4xl font-bold">Login!</p>
                        <div
                            className={`flex flex-col gap-4 justify-center items-center mt-16 ${
                                userPrefers ? "text-white" : "text-black"
                            }`}
                        >
                            <LoginButton loginProvider={handleGoogleLogin}>
                                ...
                                >
                                    <path
                                        ...
                                        stroke={userPrefers ? "white" : "black"}
                                        strokeWidth="1.5"
                                    />
                                    <path
